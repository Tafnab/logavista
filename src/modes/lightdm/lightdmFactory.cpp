...
QList<LogMode *> LightdmLogModeFactory::createLogModes() const
{
    QList<LogMode *> logModes;
    logModes.append(new LightdmLogMode());
    return logModes;
}

LogModeAction *LightdmLogModeFactory::createLogModeAction() const
{
    LogMode *logMode = Globals::instance().findLogMode(QStringLiteral(LIGHTDM_LOG_MODE_ID));
